...
```{r}
if(!dir.exists(paths = '~/multiomics/results/consensus_clustering/features/')) {
  dir.create(path = '~/multiomics/results/consensus_clustering/features/',recursive = TRUE)
}
```
...
#### Plotting
```{r}
setwd('~/multiomics/results/consensus_clustering/features/')
