...
#### Preprocessing
```{r}
proteinDataFiltered <- varianceFiltering(data = data,design = design,sampleCol = 'sample_id',annotation = 'Genes',cutoff = 0.75)
...
#### Preprocessing
```{r}
phosphoDataFiltered <- varianceFiltering(data = data,design = design,sampleCol = 'sample_id',annotation = 'Genes')
