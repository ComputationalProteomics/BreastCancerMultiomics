...
#### Preprocessing
```{r}
proteinDataFiltered <- varianceFiltering(data = data,design = design,sampleCol = 'sample_id',cutoff = 0.75)
...
#### Preprocessing
```{r}
phosphoDataFiltered <- varianceFiltering(data = data,design = design,sampleCol = 'sample_id',cutoff = 0.5)
...
#### Preprocessing
```{r}
rnaDataFiltered <- varianceFiltering(data = data,design = design,sampleCol = 'sample_id',cutoff = 0.75)
