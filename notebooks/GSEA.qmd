...
gseaMsigProt <- gseaMsigDBProt(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',FCcolname = 'Group1-Group2_log2FoldChange')
```

### Phosphoproteome
```{r}
data <- '~/multiomics/results/differentialexpression/Group1vsGroup2/phosphoproteome_peptide/phosphoproteome_peptide_stats.tsv'
gseaMsigPhospho <- gseaMsigDBPhospho(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',FCcolname = 'Group1-Group2_log2FoldChange')
```
...
gseaMsigRNA <- gseaMsigDBRNA(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',genecol = 'Gene',FCcolname = 'Group1-Group2_log2FoldChange')
```
...
gseaMsigProt <- gseaMsigDBProt(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',FCcolname = 'Group3-Group4_log2FoldChange')
```

### Phosphoproteome
```{r}
data <- '~/multiomics/results/differentialexpression/Group3vsGroup4/phosphoproteome_peptide/phosphoproteome_peptide_stats.tsv'
gseaMsigPhospho <- gseaMsigDBPhospho(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',FCcolname = 'Group3-Group4_log2FoldChange')
```
...
gseaMsigRNA <- gseaMsigDBRNA(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',genecol = 'Gene',FCcolname = 'Group3-Group4_log2FoldChange')
```
