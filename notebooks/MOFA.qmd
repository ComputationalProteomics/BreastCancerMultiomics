...
#### Save model
```{r}
saveRDS(object = MOFAobject,file = '~/multiomics/results/MOFA/all_samples/infiltration/model.RDS',compress = 'gzip')
```
...
#### Save model
```{r}
saveRDS(object = MOFAobject,file = '~/multiomics/results/MOFA/all_samples/no_infiltration/model.RDS',compress = 'gzip')
```
...
#### Save model
```{r}
saveRDS(object = MOFAobject,file = '~/multiomics/results/MOFA/Group1vsGroup2/model.RDS',compress = 'gzip')
```
...
#### Save model
```{r}
saveRDS(object = MOFAobject,file = '~/multiomics/results/MOFA/Group3vsGroup4/model.RDS',compress = 'gzip')
```
