...
gseaMsigProt <- gseaMsigDB(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',FCcolname = 'Ductal-Lobular_log2FoldChange')
```

### Phosphoproteome
```{r}
data <- '~/multiomics/results/differentialexpression/DuctalvsLobular/phosphoproteome_peptide/phosphoproteome_peptide_stats.tsv'
gseaMsigPhospho <- gseaMsigDB(data = data,qvaluecutoff = 0.25,padjustmethod = 'fdr',species = 'Homo sapiens',category = 'H',FCcolname = 'Ductal-Lobular_log2FoldChange')
```
