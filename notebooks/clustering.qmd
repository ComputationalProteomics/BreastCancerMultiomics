...
ccPhospho %<-% read_csv(file = '/multiomics/results/consensus_clustering/DuctalvsLobular/phosphoproteome/phosphoproteome.k=5.consensusClass.csv',col_names = c('sample_id','CC.Phospho'))
...
allLegends <- packLegend(legendGroup,legendNHG,legendRecurrence,legendBatch,legendBCFi,legendInvType,legendLN,legendCluster)
...
alluvialPlot <- ccAll %>% ggplot(mapping = aes(axis1=CC.Phospho,axis2=CC.Prot,axis3=CC.RNA))+geom_alluvium()+ scale_x_discrete(limits = c("Phospho", "Prot", "RNA"), expand = c(.2, .05)) +
  ...
  theme_minimal()
ggsave2(filename = 'alluvialPlot.pdf',plot = alluvialPlot,device = 'pdf',path = '/multiomics/results/figures/clustering/DuctalvsLobular/',dpi = 1200,compress=TRUE)
...
```{r}
if(!dir.exists(paths = '/multiomics/results/figures/clustering/AllSamples_noG2')) {
  dir.create(path = '/multiomics/results/figures/clustering/AllSamples_noG2',recursive = TRUE)
}
```

### Consensus Clustering Info
```{r}
ccProt %<-% read_csv(file = '/multiomics/results/consensus_clustering/AllSamples_noG2/proteome/proteome.k=6.consensusClass.csv',col_names = c('sample_id','CC.Prot'))
ccPhospho %<-% read_csv(file = '/multiomics/results/consensus_clustering/AllSamples_noG2/phosphoproteome/phosphoproteome.k=6.consensusClass.csv',col_names = c('sample_id','CC.Phospho'))
ccRNA %<-% read_csv(file = '/multiomics/results/consensus_clustering/AllSamples_noG2/transcriptome/transcriptome.k=4.consensusClass.csv',col_names = c('sample_id','CC.RNA'))

ccAll <- full_join(ccProt,ccPhospho) %>% full_join(.,ccRNA)
write_tsv(x = ccAll,file = '/multiomics/results/design_files/ductalvslobular_consensus_clustering_noG2.tsv')
```
...
alluvialPlot <- ccAll %>% ggplot(mapping = aes(axis1=CC.Phospho,axis2=CC.Prot,axis3=CC.RNA))+geom_alluvium()+ scale_x_discrete(limits = c("Phospho", "Prot", "RNA"), expand = c(.2, .05)) +
  ...
  geom_text(stat = "stratum", aes(label = after_stat(stratum))) +
  theme_minimal()
ggsave2(filename = 'alluvialPlot.pdf',plot = alluvialPlot,device = 'pdf',path = '/multiomics/results/figures/clustering/AllSamples_noG2/',dpi = 1200,compress=TRUE)

ggsave2(filename = 'kmeans_proteome.pdf',plot = proteinHeatmapDraw,device = 'pdf',path = '/multiomics/results/figures/clustering/AllSamples_noG2',dpi = 1200,width = 12,height = 12,units = 'in',compress=TRUE)
...
ggsave2(filename = 'kmeans_phosphoproteome.pdf',plot = phosphoHeatmapDraw,device = 'pdf',path = '/multiomics/results/figures/clustering/AllSamples_noG2',dpi = 1200,width = 12,height = 12,units = 'in',compress=TRUE)
...
ggsave2(filename = 'kmeans_transcriptome.pdf',plot = rnaHeatmapDraw,device = 'pdf',path = '/multiomics/results/figures/clustering/AllSamples_noG2',dpi = 1200,width = 12,height = 12,units = 'in',compress=TRUE)
...
#### Consensus Clustering Info
```{r}
ccProt %<-% read_csv(file = '/multiomics/results/consensus_clustering/LNposvsLNneg/Ductal/proteome/proteome.k=5.consensusClass.csv',col_names = c('sample_id','CC.Prot'))
...
alluvialPlot <- ccAll %>% ggplot(mapping = aes(axis1=CC.Phospho,axis2=CC.Prot,axis3=CC.RNA))+geom_alluvium()+ scale_x_discrete(limits = c("Phospho", "Prot", "RNA"), expand = c(.2, .05)) +
  ...
  geom_text(stat = "stratum", aes(label = after_stat(stratum))) +
  theme_minimal()
ggsave2(filename = 'alluvialPlot.pdf',plot = alluvialPlot,device = 'pdf',path = '/multiomics/results/figures/clustering/LNposvsLNneg/Ductal/',dpi = 1200,compress=TRUE)
...
```{r}
if(!dir.exists(paths = '/multiomics/results/figures/clustering/LNposvsLNneg/Ductal_noG2')) {
  dir.create(path = '/multiomics/results/figures/clustering/LNposvsLNneg/Ductal_noG2',recursive = TRUE)
}
```

#### Consensus Clustering Info
```{r}
ccProt %<-% read_csv(file = '/multiomics/results/consensus_clustering/LNposvsLNneg/Ductal_noG2/proteome/proteome.k=4.consensusClass.csv',col_names = c('sample_id','CC.Prot'))
ccPhospho %<-% read_csv(file = '/multiomics/results/consensus_clustering/LNposvsLNneg/Ductal_noG2/phosphoproteome/phosphoproteome.k=6.consensusClass.csv',col_names = c('sample_id','CC.Phospho'))
ccRNA %<-% read_csv(file = '/multiomics/results/consensus_clustering/LNposvsLNneg/Ductal_noG2/transcriptome/transcriptome.k=5.consensusClass.csv',col_names = c('sample_id','CC.RNA'))

ccAll <- full_join(ccProt,ccPhospho) %>% full_join(.,ccRNA)
write_tsv(x = ccAll,file = '/multiomics/results/design_files/lnposvslnneg_ductal_consensus_clustering_noG2.tsv')
```
...
alluvialPlot <- ccAll %>% ggplot(mapping = aes(axis1=CC.Phospho,axis2=CC.Prot,axis3=CC.RNA))+geom_alluvium()+ scale_x_discrete(limits = c("Phospho", "Prot", "RNA"), expand = c(.2, .05)) +
  ...
  geom_text(stat = "stratum", aes(label = after_stat(stratum))) +
  theme_minimal()
ggsave2(filename = 'alluvialPlot.pdf',plot = alluvialPlot,device = 'pdf',path = '/multiomics/results/figures/clustering/LNposvsLNneg/Ductal_noG2/',dpi = 1200,compress=TRUE)

ggsave2(filename = 'kmeans_proteome.pdf',plot = proteinHeatmapDraw,device = 'pdf',path = '/multiomics/results/figures/clustering/LNposvsLNneg/Ductal_noG2/',dpi = 1200,width = 12,height = 12,units = 'in',compress=TRUE)
...
ggsave2(filename = 'kmeans_phosphoproteome.pdf',plot = phosphoHeatmapDraw,device = 'pdf',path = '/multiomics/results/figures/clustering/LNposvsLNneg/Ductal_noG2/',dpi = 1200,width = 12,height = 12,units = 'in',compress=TRUE)
...
ggsave2(filename = 'kmeans_transcriptome.pdf',plot = rnaHeatmapDraw,device = 'pdf',path = '/multiomics/results/figures/clustering/LNposvsLNneg/Ductal_noG2/',dpi = 1200,width = 12,height = 12,units = 'in',compress=TRUE)
...
ccPhospho %<-% read_csv(file = '/multiomics/results/consensus_clustering/LNposvsLNneg/Lobular/phosphoproteome/phosphoproteome.k=4.consensusClass.csv',col_names = c('sample_id','CC.Phospho'))
ccRNA %<-% read_csv(file = '/multiomics/results/consensus_clustering/LNposvsLNneg/Lobular/transcriptome/transcriptome.k=4.consensusClass.csv',col_names = c('sample_id','CC.RNA'))
...
alluvialPlot <- ccAll %>% ggplot(mapping = aes(axis1=CC.Phospho,axis2=CC.Prot,axis3=CC.RNA))+geom_alluvium()+ scale_x_discrete(limits = c("Phospho", "Prot", "RNA"), expand = c(.2, .05)) +
  ...
  geom_text(stat = "stratum", aes(label = after_stat(stratum))) +
  theme_minimal()
ggsave2(filename = 'alluvialPlot.pdf',plot = alluvialPlot,device = 'pdf',path = '/multiomics/results/figures/clustering/LNposvsLNneg/Lobular/',dpi = 1200,compress=TRUE)
...
ccPhospho %<-% read_csv(file = '/multiomics/results/consensus_clustering/Group1vsGroup2/phosphoproteome/phosphoproteome.k=6.consensusClass.csv',col_names = c('sample_id','CC.Phospho'))
...
alluvialPlot <- ccAll %>% ggplot(mapping = aes(axis1=CC.Phospho,axis2=CC.Prot,axis3=CC.RNA))+geom_alluvium()+ scale_x_discrete(limits = c("Phospho", "Prot", "RNA"), expand = c(.2, .05)) +
  ...
  geom_text(stat = "stratum", aes(label = after_stat(stratum))) +
  theme_minimal()
ggsave2(filename = 'alluvialPlot.pdf',plot = alluvialPlot,device = 'pdf',path = '/multiomics/results/figures/clustering/Group1vsGroup2/',dpi = 1200,compress=TRUE)
...
### Consensus Clustering Info
```{r}
ccProt %<-% read_csv(file = '/multiomics/results/consensus_clustering/Group3vsGroup4/proteome/proteome.k=4.consensusClass.csv',col_names = c('sample_id','CC.Prot'))
ccPhospho %<-% read_csv(file = '/multiomics/results/consensus_clustering/Group3vsGroup4/phosphoproteome/phosphoproteome.k=4.consensusClass.csv',col_names = c('sample_id','CC.Phospho'))
ccRNA %<-% read_csv(file = '/multiomics/results/consensus_clustering/Group3vsGroup4/transcriptome/transcriptome.k=4.consensusClass.csv',col_names = c('sample_id','CC.RNA'))
...
alluvialPlot <- ccAll %>% ggplot(mapping = aes(axis1=CC.Phospho,axis2=CC.Prot,axis3=CC.RNA))+geom_alluvium()+ scale_x_discrete(limits = c("Phospho", "Prot", "RNA"), expand = c(.2, .05)) +
  ...
  geom_text(stat = "stratum", aes(label = after_stat(stratum))) +
  theme_minimal()
ggsave2(filename = 'alluvialPlot.pdf',plot = alluvialPlot,device = 'pdf',path = '/multiomics/results/figures/clustering/Group3vsGroup4/',dpi = 1200,compress=TRUE)
