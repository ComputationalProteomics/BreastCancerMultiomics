...
# Import Data
```{r}
data <- read_tsv(file = '/multiomics/results/design_files/mergedDesign_ref_hisscore.tsv') |> 
...
gtsave(data = table1Clinic, filename = 'table1_patient_tumor_characteristics.html', path = '/multiomics/results/figures' )
```