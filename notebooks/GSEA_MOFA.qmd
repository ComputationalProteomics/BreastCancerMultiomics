...
```{r}
model <- readRDS(file = '/multiomics/results/MOFA/LNposvsLNneg/Ductal/model.RDS')
```
...
ggsave(filename = 'GSEA_Group3vsGroup4.png',plot = p,device = 'png',path = '/multiomics/results/figures/MOFA/LNposvsLNneg/Ductal/',units = 'in',width = 10,height = 12,dpi = 600)
...
```{r}
model <- readRDS(file = '/multiomics/results/MOFA/LNposvsLNneg/Lobular/model.RDS')
```
...
ggsave(filename = 'GSEA_Group3vsGroup4.png',plot = p,device = 'png',path = '/multiomics/results/figures/MOFA/LNposvsLNneg/Lobular/',units = 'in',width = 10,height = 12,dpi = 600)
...
```{r}
model <- readRDS(file = '/multiomics/results/MOFA/AllSamples_noG2/model.RDS')
```
...
ggsave(filename = 'GSEA_allsamples_infiltration.png',plot = p,device = 'png',path = '/multiomics/results/figures/MOFA/AllSamples_noG2/',units = 'in',width = 10,height = 12,dpi = 600)
