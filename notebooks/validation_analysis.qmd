...
drfi_genes_mofa <- c('THBS1','THBS2','MFGE8','MYH9','MYH10','MYH11','RBM39','KCND3')
...
features <- features %>% mutate(across(common_genes[["Gene.Name"]],as.numeric)) %>% select(-c(CBFA2T3,CNN1))
