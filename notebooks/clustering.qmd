...
#### Preprocessing
```{r}
proteinDataFiltered <- medianFiltering(data = data,design = design,sampleCol = 'sample_id',annotation = 'Protein',cutoff = 0.75)
...
set.seed(123)
proteinHeatmap <- future(seed = TRUE,globals = TRUE,packages = c('ComplexHeatmap'),gc = TRUE, expr = {Heatmap(matrix = proteindataNorm,top_annotation = annotationColumn, name = 'Protein intensity',heatmap_legend_param = list(legend_direction = 'horizontal'),cluster_rows = TRUE,cluster_row_slices = TRUE,row_km = 5,column_split = design$CC.Prot)})
```
...
varKeep <- c('medianFiltering','NAFiltering','gprofilerEnrichment','ccAll','calZScore','varKeep')
...
#### Preprocessing
```{r}
phosphoDataFiltered <- medianFiltering(data = data,design = design,sampleCol = 'sample_id',annotation = 'Precursor.Id',cutoff = 0.5)
...
annotationColumn %<-% HeatmapAnnotation(Group=anno_simple(x = design$Group.Info,
                                      ...
                                      InvasiveType=anno_simple(x = design$InvCa.type,
                                                       ...
                                                       na_col = 'white',
                                                       gp = gpar(title='InvasiveType')),
                                      Phophoproteome.Cluster=anno_simple(x = design$CC.Phospho,
                                                                   col = clusterCol))
...
set.seed(123)
phosphoHeatmap <- future(seed = TRUE,globals = TRUE,packages = c('ComplexHeatmap'),gc = TRUE, expr = {Heatmap(matrix = phosphodataNorm,top_annotation = annotationColumn, name = 'Protein intensity',heatmap_legend_param = list(legend_direction = 'horizontal'),cluster_rows = TRUE,cluster_row_slices = TRUE,row_km = 5,column_split = design$CC.Phospho)})
```
...
phosphoGroups <- future_map(.x = seq_along(rowOrder),.f = ~(phosphoDataFiltered$Protein[rowOrder[[.x]]]))
...
#### Preprocessing
```{r}
rnaDataFiltered <- medianFiltering(data = data,design = design,sampleCol = 'sample_id',annotation = 'Gene.ID',cutoff = 0.75)
...
nhgCol <- colorspace::sequential_hcl(n = 3,palette = 'Light Grays',rev = TRUE) %>% setNames(nm = c(1:3))
dfrCol <- colorspace::sequential_hcl(n = 2,palette = 'Light Grays',l2 = 80,rev = TRUE) %>% setNames(nm = c(0:1))
clusterCol <- colorspace::sequential_hcl(n = 7,palette = 'Purple-Yellow') %>% setNames(nm = c(1:7))
```
...
annotationColumn %<-% HeatmapAnnotation(Group=anno_simple(x = design$Group.Info,
                                      ...
                                      InvasiveType=anno_simple(x = design$InvCa.type,
                                                       ...
                                                       na_col = 'white',
                                                       gp = gpar(title='InvasiveType')),
                                      Proteome.Cluster=anno_simple(x = design$CC.RNA,
                                                                   col = clusterCol))
...
set.seed(123)
rnaHeatmap <- future(seed = TRUE,globals = TRUE,packages = c('ComplexHeatmap'),gc = TRUE, expr = {Heatmap(matrix = rnadataNorm,top_annotation = annotationColumn, name = 'Gene Expression',heatmap_legend_param = list(legend_direction = 'horizontal'),cluster_rows = TRUE,cluster_row_slices = TRUE,row_km = 5,column_split = design$CC.RNA)})
```
...
ccRNA %<-% read_csv(file = '~/multiomics/results/consensus_clustering/LNposvsLNneg/Ductal/transcriptome/transcriptome.k=5.consensusClass.csv',col_names = c('sample_id','CC.RNA'))
...
annotationColumn %<-% HeatmapAnnotation(Group=anno_simple(x = design$Group.Info,
                                      ...
                                      InvasiveType=anno_simple(x = design$InvCa.type,
                                                       ...
                                                       na_col = 'white',
                                                       gp = gpar(title='InvasiveType')),
                                      Transcriptome.Cluster=anno_simple(x = design$CC.RNA,
                                                                   col = clusterCol),
                                      LN=anno_simple(x = design$LN,
                                                     col = dfrCol,
                                                     na_col = 'white'))
