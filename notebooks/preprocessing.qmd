...
design <- read_tsv('/multiomics/results/design_files/mergedDesign_ref_hisscore.tsv') %>% 
...
write_tsv(x = newGenes,file =  '/multiomics/data/transcriptomics/genematrix_adjusted_cycloess.tsv')
```
