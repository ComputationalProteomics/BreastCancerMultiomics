...
phospho <- phosphodata %>%
  varianceFiltering(design = design,sampleCol = 'sample_id',annotation = 'Modified.Sequence',cutoff = 0.75)
...
#### Save model
```{r}
saveRDS(object = bestModel,file = '/multiomics/results/MOFA/MOFA/AllSamples_noG2/model.RDS',compress = 'gzip')
```
