...
prot <- proteindata %>% 
  madFfiltering(design = design,sampleCol = 'sample_id',annotation = 'Protein',cutoff = 0.75)
...
phospho <- phosphodata %>%
  madFfiltering(design = design,sampleCol = 'sample_id',annotation = 'Modified.Sequence',cutoff = 0.75)
...
gene <- genedata %>% 
  madFfiltering(design = design,sampleCol = 'sample_id',annotation = 'Gene.ID',cutoff = 0.75)
...
```{r}
varskeep <- c('workers','madFfiltering','NAFiltering')
