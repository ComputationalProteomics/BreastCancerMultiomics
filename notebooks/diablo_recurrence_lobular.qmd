...
if(!dir.exists(paths = '/Users/analysis/Desktop/Sergio/multiomics/results/DIABLO/recurrence/Lobular')) {
  dir.create(path = '/Users/analysis/Desktop/Sergio/multiomics/results/DIABLO/recurrence/Lobular',recursive = TRUE)
}

if(!dir.exists(paths = '/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular')) {
  dir.create(path = '/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular',recursive = TRUE)
}
```
...
test.keepX <- list(proteomics = c(seq(1,41,10)),
                   phosphoproteomics = c(seq(1,41,10)),
                   transcriptomics = c(seq(1,41,10)))
...
test.keepX <- list(proteomics = c(seq(15,25,1)),
                   phosphoproteomics = c(seq(25,35,1)),
                   transcriptomics = c(seq(5,15,1)))
...
### Final model
```{r}
final.diablo.tune1 <- block.splsda(X = dataTrain, Y = responseTrain, ncomp = 1, 
                          keepX = tune.diablo$choice.keepX, design = design)
final.diablo.tune2 <- block.splsda(X = dataTrain, Y = responseTrain, ncomp = 1, 
                          keepX = tune.diablo2$choice.keepX, design = design)
final.diablo.tune3 <- block.splsda(X = dataTrain, Y = responseTrain, ncomp = 1, 
...
purrr::map2(.x = models,.y = c('lobular.tune1','lobular.tune2','lobular.tune3'),function(model,name){
  saveRDS(object = model,file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/DIABLO/recurrence/Lobular/',name,'.gzip'),compress = 'gzip')
})
```
...
purrr::map2(.x = modelVar,.y = c('lobular.tune1','lobular.tune2','lobular.tune3'),function(model,name){
  write_tsv(x = model,paste0('/Users/analysis/Desktop/Sergio/multiomics/results/DIABLO/recurrence/Lobular/',name,'_variables','.tsv'))
  })
```
...
purrr::map2(.x = models,
            ...
            function(model,name){
              ncomp <- model[['ncomp']][['Y']]
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_markerPlot','.pdf'),width =30,height = 10,onefile = TRUE)
...
purrr::map2(.x = models,
            ...
            function(model,name){
              ncomp <- model[['ncomp']][['Y']]
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_corrPlot','.pdf'),width = 10,height = 10,onefile = TRUE)
...
purrr::map2(.x = models,
            .y = c('lobular.tune1','lobular.tune2','lobular.tune3'),
            function(model,name){
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_circosPlot','.pdf'),onefile = TRUE)
...
purrr::map2(.x = models,
            .y = c('lobular.tune1','lobular.tune2','lobular.tune3'),
            function(model,name){
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_networkPlot','.pdf'),width = 30,height = 30,compress = TRUE)
              networkResult <- network(model,
                      ...
                      graph.scale = 1)
              dev.off()
              write_graph(graph = networkResult$gR,file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_networkPlot','.gml'),format = 'gml')
            }
)
```
...
purrr::map2(.x = models,
            ...
            function(model,name){
              ncomp <- model[['ncomp']][['Y']]
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_LoadingsPlot','.pdf'),onefile = TRUE,width = 20,height = 20)
...
purrr::map2(.x = models,
            ...
            function(model,name){
              ncomp <- model[['ncomp']][['Y']]
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_heatmap','.pdf'),onefile = TRUE,width = 10,height = 10)
...
purrr::map2(.x = models,
            .y = c('lobular.tune1','lobular.tune2','lobular.tune3'),
            function(model,name){
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_AUC','.pdf'),onefile = TRUE,width = 10,height = 10)
...
purrr::map2(.x = models,
            ...
            function(model,name){
              ...
              pdf(file = paste0('/Users/analysis/Desktop/Sergio/multiomics/results/figures/DIABLO/recurrence/Lobular/',name,'_performance','.pdf'))
              plot(perf.diablo)
              dev.off()
            }
)
...
```{r}
predict.diablo = predict(final.diablo.tune3, newdata = dataTest)
confusion.mat = get.confusion_matrix(truth = responseTest,
                     predicted = predict.diablo$MajorityVote$max.dist)
confusion.mat
```
