...
params:
  ...
  mutation_design: '/multiomics/data/mutation/samples.tsv'
  hiscore_data: '/multiomics/data/Immune_infiltration/HisScoreComplete.tsv'
  ref_design_mutation: '/multiomics/results/design_files/mergedDesign_ref_mutation.tsv'
  ...
  proteome_noPool_noG2: '/multiomics/results/design_files/design_Full_noPool_noG2.tsv'
  phospho_noPool_noG2: '/multiomics/results/design_files/design_phospho_noPool_noG2.tsv'
  transcriptome_noPool_noG2: '/multiomics/results/design_files/design_RNA_noPool_noG2.tsv'
  ...
  proteome_ductal_noG2: '/multiomics/results/design_files/design_full_ductal_noG2.tsv'
  phospho_ductal_noG2: '/multiomics/results/design_files/design_phospho_ductal_noG2.tsv'
  transcriptome_ductal_noG2: '/multiomics/results/design_files/design_RNA_ductal_noG2.tsv'
  ...
  multiomics_mofa: '/multiomics/results/design_files/design_multiomics_mofa.tsv'
  proteome_g1g2: '/multiomics/results/design_files/design_full_g1g2.tsv'
  phospho_g1g2: '/multiomics/results/design_files/design_phospho_g1g2.tsv'
  transcriptome_g1g2: '/multiomics/results/design_files/design_RNA_g1g2.tsv'
  proteome_g3g4: '/multiomics/results/design_files/design_full_g3g4.tsv'
  phospho_g3g4: '/multiomics/results/design_files/design_phospho_g3g4.tsv'
  transcriptome_g3g4: '/multiomics/results/design_files/design_RNA_g3g4.tsv'
---
...
```
```{r}
if(!dir.exists(paths = '/multiomics/results/design_files/')) {
  dir.create(path = '/multiomics/results/design_files/',recursive = TRUE)
}
```
...
mutation_design <- read_tsv(file = params$mutation_design,col_names = TRUE,skip = 19) %>% 
  dplyr::select(SAMPLE,22:25,35:51)
hiscore_data <- read_tsv(file = params$hiscore_data)

referenceDesign <- left_join(x = referenceDesign,y = mutation_design,by = c('Merged'='SAMPLE'))
referenceDesign <- left_join(x = referenceDesign,y = hiscore_data,by = c('Sample'='Name'))
write_tsv(x = referenceDesign,file = params$ref_design_mutation)
```

## Full Proteome
```{r Design Files Full Proteome Data}
#| message: false
referenceDesign <- read_tsv(file = params$ref_design_mutation,col_names = TRUE)
...
designMix <- inner_join(x = designprotein,y = designphospho,by = colnames(designphospho)[-c(1,2,4:6,128)])
