...
# Load Required Data
```{r}
immuneFeat <- read_tsv(file = '/home/multiomics/data/Immune_infiltration/CIBERSORTx_Job41_Results_transcriptomics_LM22-absolute.txt')
...
ggsave(filename = "LM22_boxplot.pdf",plot = plot,device = "pdf",path = "/home/multiomics/results/figures/immune_infiltration",height = 20,width = 15,units = "in",dpi = 600,create.dir = TRUE)
```
