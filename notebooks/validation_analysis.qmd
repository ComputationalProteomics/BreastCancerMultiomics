...
```{r Output Directory}
outputdir <- paste0('/multiomics/results/figures/validation/',params$event,'/')
...
ggsave(filename = 'forestplot_univariable_all_samples.pdf',plot = uniPlot,device = 'pdf',path = outputdir,dpi = 600)
```
...
cairo_pdf(filename = paste0(outputdir,'forestplot_multivariable_all_samples.pdf'),onefile = TRUE,width = 9,height = 9)
...
ggsave(filename = 'forestplot_univariable_LNneg.pdf',plot = uniPlot,device = 'pdf',path = outputdir,dpi = 600)
```
...
ggsave(filename = 'forestplot_univariable_LNpos.pdf',plot = uniPlot,device = 'pdf',path = outputdir,dpi = 600)
```
